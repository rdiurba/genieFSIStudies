#ifndef FSIREWEIGHT_H
#define FSIREWEIGHT_H
...
// ============================================================
// Per-event reweight: returns (hAEst, AltEst) pair
// given mult, diff, KEini, and the chosen reweight model.
// Caller computes rw = visERW * (AltEst / hAEst).
// ============================================================
...
const LinearParams& altDifStd  = (reweightModel == "hN2018") ? tp.DifStd.hN    :
        ...
        if (AltEst/hAEst<0.01){ AltEst=1; hAEst=10;}
