...
// =======================================================
void plotTotalNucl(int probe, double ke, int target,
...
leg->Draw();
    ...
    if (mode==kAbs){
        ...
        else if(compound)             file.open("pionAbsSumCompoundThresh.txt", std::ios_base::app);
        else
            file.open("pionAbsSum.txt", std::ios_base::app);
        ...
        else if(compound)             file.open("nucleonKOSumCompoundThresh.txt", std::ios_base::app);
        else
            file.open("nucleonKOSum.txt", std::ios_base::app);

        file << probe << "," << ke << "," << target << ","
             << g1->GetParameter(0) << "," << g1->GetParError(0) << ","
             << g1->GetParameter(1) << "," << g1->GetParError(1) << ","
             << g2->GetParameter(0) << "," << g2->GetParError(0) << ","
             << g2->GetParameter(1) << "," << g2->GetParError(1) << ","
             << g3->GetParameter(0) << "," << g3->GetParError(0) << ","
             << g3->GetParameter(1) << "," << g3->GetParError(1) << ","
             << g4->GetParameter(0) << "," << g4->GetParError(0) << ","
             << g4->GetParameter(1) << "," << g4->GetParError(1)
             << std::endl;
    }
