...
// =======================================================
void plotTotNuclwAllRW(int probe=211, double ke=0.525, int target=1000180400,
...
h4->Scale(1.0 / h4->Integral());
    ...
    if (probe<212 && ke<0.250) h1->GetYaxis()->SetRangeUser(0,1.0);
    if (ke<0.350) h1->GetYaxis()->SetRangeUser(0,0.8);
    h1->Draw("HIST");
    h2->Draw("HIST SAME");
    h3->Draw("HIST SAME");
    h4->Draw("HIST SAME");
